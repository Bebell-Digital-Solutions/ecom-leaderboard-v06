...
class DataStore {
    ...
    initializeDemoData() {
        if (this.stores.length === 0) {
            const demoStores = [
                { name: 'ElectroMundo', email: 'demo@electromundo.com', url: 'https://electromundo.com', currency: 'DOP'},
                { name: 'Moda Caribeña', email: 'demo@modacaribe.com', url: 'https://modacaribe.com', currency: 'DOP'},
                { name: 'USA Gadgets', email: 'demo@usagadgets.com', url: 'https://usagadgets.com', currency: 'USD'},
                { name: 'Deportes Total', email: 'demo@deportestotal.com', url: 'https://deportestotal.com', currency: 'DOP'},
                { name: 'Belleza Tropical', email: 'demo@bellezatropical.com', url: 'https://bellezatropical.com', currency: 'USD'},
            ];
...
function handleRegister(event) {
    ...
    const newStoreData = { name: storeName, email, password, url, currency };
